...
import { NotificationTime, useSettingsStore } from "@/store/settingsStore";
import { Edit3, Plus, RotateCcw, TestTube, Trash2 } from "lucide-react-native";
...
export const NotificationTimeManager: React.FC<
  NotificationTimeManagerProps
> = ({ isDarkMode }) => {
  const {
    notificationTimes,
    addNotificationTime,
  ...
  const handleAddTime = () => {
    ...
    if (
      ...
      Alert.alert(
        "Invalid Time",
        "Please enter a valid time (0-23 hours, 0-59 minutes)"
      );
      return;
    }
    ...
    if (!newLabel.trim()) {
      Alert.alert(
        "Missing Label",
        "Please enter a label for this notification"
      );
      return;
    }
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.card }]}>
            ...
            <View style={styles.timeInputContainer}>
              ...
              <Text style={[styles.timeSeparator, { color: theme.text }]}>
                :
              </Text>
              <View style={styles.timeInputGroup}>
                <Text style={[styles.inputLabel, { color: theme.text }]}>
